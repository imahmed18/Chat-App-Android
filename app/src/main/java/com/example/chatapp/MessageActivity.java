    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //startActivity(new Intent(MessageActivity.this,MainActivity.class).setFlags());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot snapshot1:snapshot.getChildren()){
                    ...
                    Data data=new Data(fuser.getUid(),R.mipmap.ic_launcher,username+": "+message,"Chat App: New Message",userid);

                    Sendder sender=new Sendder(data,token.getToken());
